...
},{"../":3,"react":158}],3:[function(require,module,exports){
'use strict';
...
var Geocoder = React.createClass({
  ...
  onInput: function onInput(e) {
    ...
    if (value === '') {
      ...
      search(this.props.endpoint, this.props.source, this.props.accessToken, this.props.proximity, this.props.bbox, value, this.onResult);
    }
  },
...
},{"./search":166,"react":158}],4:[function(require,module,exports){
/**
...
function search(endpoint, source, accessToken, proximity, bbox, query, callback) {
  ...
  var uri = endpoint + '/geocoding/v5/' + source + '/' + encodeURIComponent(query) + '.json' + '?access_token=' + accessToken + (proximity ? '&proximity=' + proximity : '') + (bbox ? '&bbox=' + bbox : '');
  xhr({
    uri: uri,
    json: true
